...
const tabs = [
	{ value: "colours", label: "Colours", icons: Hash },
	{ value: "typography", label: "Typography", icons: Type },
	{ value: "moodboard", label: "Moodboard", icons: LayoutIcon },
] as const;
					...
					<div className="flex flex-col lg:flex-row gap-4 lg:gap-5 items-center justify-between">
						<div>
							...
							<p className="text-muted-foreground mt-2 text-center lg:text-left">
								Manage style guide for your project design.
							</p>
						</div>
